...
import ru.vekotov.backend.DTO.GetVotingStatsResult;
...
public class HandlerController {
    ...
    @GetMapping("/votes/smallestTimestamp")
    Long getSmallestTimestamp() {
        return ds.getSmallestTimestamp();
    }

    @GetMapping("/votes/biggestTimestamp")
    Long getBiggestTimestamp() {
        return ds.getBiggestTimestamp();
    }
    ...
    @ResponseBody
    public GetVotingStatsResult getVotingStatsHandler(
        ...
        result.setData(ds.GetVotingStats(from, to, intervals, artists));
